...
import { BriefcaseIcon, MoonIcon, SunIcon } from '@heroicons/vue/24/outline';
import { ref } from 'vue';
          ...
          <div class="bg-white dark:bg-feub-secondary-dark rounded-xl p-6">
            <div class="flex justify-start gap-4">
              <ButtonWithIcon @showPart="onClickExp" :isShowing="showExp">
                <template #icon>
                  <BriefcaseIcon class="size-5" :class="showExp ? 'text-white' : 'text-feub-primary'" />
                </template>
                <template #default>
              ...
              <ButtonWithIcon @showPart="onClickEdu" :isShowing="showEdu">
                <template #icon>
                  <BriefcaseIcon class="size-5" :class="showEdu ? 'text-white' : 'text-feub-primary'" />
                </template>
                <template #default>
                  Education
                </template>
